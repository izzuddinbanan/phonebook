<div class="container">
	<div class="row">
		<div class="col-sm-6 col-md-4">
			<div class="thumbnail">
				<img src="<?php echo base_url();?>assets/image/book.jpg" alt="...">
				<div class="caption">
		...
		<div class="col-sm-6 col-md-4">
			<div class="thumbnail">
				<img src="<?php echo base_url();?>assets/image/phone.jpg" alt="...">
				<div class="caption">
					...
					purpose (injected humour.</p>
				</div>
			</div>
		</div>
		<div class="col-sm-6 col-md-4">
			<div class="thumbnail">
				<img src="<?php echo base_url();?>assets/image/book2.jpg" alt="...">
				<div class="caption">
					...
					200 Latin words, combined with a handful of model sentence  </p>
				</div>
			</div>
		</div>
	</div>
